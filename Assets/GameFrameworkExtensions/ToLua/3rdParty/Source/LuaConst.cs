...
{
    public static string luaDir = Application.dataPath + "/GameFrameworkExtensions/ToLua/3rdParty/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/GameFrameworkExtensions/ToLua/3rdParty/ToLua/Lua";        //tolua lua文件目录
